...
#On teste si toutes les pops sont occupées
          ifelse(length(unique(temp$pop))==24,
                 ...
                 #On pourrait aussi le faire avec nlme mais semble poser des problèmes  lme(G1~1,data = temp, random = ~1|Population/Environment/pop,na.action = na.fail)
...
write.table(results, file="QSTs_Sims2Conti_lmer.txt")
####
